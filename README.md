...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&duration=3000&pause=1000&color=7AA2F7&center=true&vCenter=true&width=600&lines=Hi+%F0%9F%91%8B%2C+I'm+Deepanshu+Gupta;Backend+Developer;Building+Event-Driven+%26+AI-Integrated+Systems;IEEE+Published+Researcher" alt="Typing SVG" />
...
Backend-focused Computer Science undergraduate (AIML) at **SRM Institute of Science and Technology**, with a strong grip on Data Structures & Algorithms, OOP, and building production-grade backend systems in **Node.js** and **Python**. I like designing services that stay fast and reliable under real traffic, and I recently co-authored an **IEEE-published paper** on hybrid crowd-AI misinformation verification.

- 🔭 Currently building backend services and integrating LLM-driven APIs into production systems
- 🌱 Deepening my skills in **Generative AI** and applied LLM engineering
- 💼 Backend Developer experience at **Insturix** (tech startup) and **Rubaroo**, SRM's annual cultural fest
- 📄 Co-author, *"VoxVeritas: A Hybrid Crowd-AI Architecture for Misinformation Verification"* — IEEE published
- 🎯 Actively looking for full-time / internship backend engineering opportunities
- 💬 Ask me about Node.js, Express, system design, DSA, or AI-integrated backends
- 📫 Reach me at **deepanshugupta650@gmail.com**
...
- Automated Gemini API key rotation, cutting rate-limit failures **40%** and holding **98.2%** uptime
- Optimized MongoDB schemas & indexing, cutting average query time **30%**
...
- Sustained **1,000+** requests/day at **<200ms** latency on registration & scheduling endpoints
- Automated transactional emails via Nodemailer at **99.5%** delivery across 1,500+ notifications
...
> **VoxVeritas: A Hybrid Crowd-AI Architecture for Misinformation Verification** — *IEEE Published*

Co-authored an end-to-end system design paper for a sociotechnical misinformation-verification platform, combining crowd judgment with AI-assisted analysis.

- Sybil-resistant One-Person-One-Vote system using face embeddings — cut bot activity **95%**
...
- **Web Developer & Core Member — HackHound** (College Club), SRM IST: led backend integration for club hackathons, mentored 3 junior developers on Git workflows and API best practices
- **Team Lead — HackStasy** (Microsoft Azure Developer Community Hackathon): led a team building an AI-powered mental-health chatbot for college students — finished **Top 5**
- Solved **400+** DSA problems across LeetCode & TakeUForward, recognized as a Consistent Performer
...
![Pinecone](https://img.shields.io/badge/Pinecone-Vector%20DB-0A66C2?style=for-the-badge)
